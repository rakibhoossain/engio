...
<div class="card">
    <div class="card-header">
        {{ trans('global.edit') }} Corona Post
    </div>

    <div class="card-body">
        <form action="{{ route("admin.corona.update", $corona->slug) }}" method="POST" enctype="multipart/form-data">
            @method('PUT')
            @csrf
            ...
            <div class="row">
                ...
                <div id="images" class="col-md-6">
                  ...
                  <div class='preview_single'>
                    <img src="{{asset($corona->image)}}" width="100" height="100">
